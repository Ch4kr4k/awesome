...
local globalKeys =
    ...
    -- Hotkeys
        ...
        awful.key(
            ...
            'c',
            function()
                -- awful.util.spawn("sudo emacsclient -c -a 'emacs'")
  ...
  awful.key(
    ...
    {description = 'Show weather', group = 'widgets'}
        ...
        awful.key(
            ...
            {description = 'move to next monitor', group = 'client'}
        ),
        ...
        awful.key(
            ...
            'i',
            function() awful.screen.focus_relative(-1) end,
            {description = 'move to previous monitor', group = 'client'}
        ),
